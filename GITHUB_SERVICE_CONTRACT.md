...
The detailed executable claims for the P1 REST subset are defined in
[`docs/api-endpoint-claims.md`](./docs/api-endpoint-claims.md). That document
narrows the first implementation to installation-token creation and targeted PR
retrieval without claiming general GitHub REST compatibility.
